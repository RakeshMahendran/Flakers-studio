...
import { CustomMessageRenderer } from "@/components/tambo/custom-message-renderer";
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* Custom RAG Result Renderer */}
                {message.role === "assistant" && <CustomMessageRenderer message={message} />}
              </div>
            </Message>
          </div>
        );
